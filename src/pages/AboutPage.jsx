...
const AboutPage = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "Démarrage rapide sur place",
      icon: <Car className="w-8 h-8" />
    },
    {
      title: "Changement de pneu",
      description: "Remplacement rapide sur le lieu de panne",
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                <div className="flex items-center space-x-3 bg-gray-800/50 px-6 py-4 rounded-xl">
                  ...
                  <div className="text-left">
                    ...
                    <div className="text-2xl font-bold">71 234 567</div>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3 bg-gray-800/50 px-6 py-4 rounded-xl">
                  ...
                  <div className="text-left">
                    ...
                    <div className="font-medium">Ben Arous, Tunisie</div>
                  </div>
                </div>
              </div>
