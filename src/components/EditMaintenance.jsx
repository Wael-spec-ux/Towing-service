...
export function EditTruckModal({setshowEditTruckModal, truckPlate,setTrucks}) {
  ...
  const handEditTruck =async()=>{
    await updateTruckMaintenance(LastMaintenance,NextMaintenance,NewLocation,truck._id);
    setNewLocation(null);
        ...
        <div className="bg-gray-800 rounded-2xl border border-gray-700 max-w-md w-full p-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <label htmlFor="">{truck?.plate}</label>
            </div>
            <div>
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => setLastMaintenance({lastMaintenance: e.target.value })}
                className="w-full px-4 py-2 bg-gray-900 border border-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
            <div>
              ...
              <input
                ...
                onChange={(e) => setNextMaintenance({ nextMaintenance: e.target.value })}
                className="w-full px-4 py-2 bg-gray-900 border border-gray-700 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
            </div>
